...
class ControlloreListaSpeseRicavi():
    def __init__(self):
        ...
        if os.path.isfile("spesericavi/InsermentoSpeseRicavi/ListaSR/lista_movimenti.pickle"):
            print("Esiste")
            with open("spesericavi/InsermentoSpeseRicavi/ListaSR/lista_movimenti.pickle","rb")as f:
    ...
    def aggiungi_voce(self,descrizione,segno,importo):
        ...
        with open("spesericavi/InsermentoSpeseRicavi/ListaSR/lista_movimenti.pickle","wb") as handle:
